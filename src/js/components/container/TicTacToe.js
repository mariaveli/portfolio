...
import TicButton from "../presentational/tictactoeButton";
            ...
            <div className={"obj-al-col"}>
                ...
                <div >
                    <div className="grid-container">
                        {Grid.map(obj => <TicButton  reset={this.state.reset} btnNum={obj.number}  id={obj.id} activePlayer={this.state.activePlayer} nextPlayer={this.nextPlayer.bind(this)} updateStateGame={this.updateStateGame.bind(this)} activeGame={this.state.activeGame}/>)}
                    </div></div>
                <div className={"boxy"}>
